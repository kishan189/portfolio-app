...
const ContactMe = () => {
    ...
    const allSkills =[
        ...
        , {
            id:2,
            title:'aktkishansingh@gmail.com',
            href:'aktkishansingh@gmail.com',
            src:email,
            width:'20px',
            colorScheme: 'gray',
        ...
        , {
            id:3,
            title:'LinkedIn',
            href:'https://www.linkedin.com/in/kishan-singh-50a963201/',
            src:linkedin,
            width:'20px',
            colorScheme: 'gray',
        ...
        , {
            id:4,
            title:'GitHub',
            href:'https://github.com/kishan189',
            src:githubIcon,
            width:'20px',
            colorScheme: 'gray',
  ...
  const handleSubmit = (e) => {
    ...
    // sercie id , template id, public key
    emailjs.send('service_ukpkro9', 'template_c63at3r', formData, 'iEnyFgZJrulU_-IHz')
      .then((response) => {
  ...
  return (
    ...
    <Flex w={'100%'} gap={'10px'} justifyContent={'center'} alignItems={'center'}  flexWrap={'wrap'}  >
        ...
        <Text fontSize={'xl'}>Gorakhpur, Uttar Pradesh</Text>
    </Flex>
    </Flex>
